...
mixin _$OrderDetails {
  ...
  int get oderId => throw _privateConstructorUsedError;
...
class _$OrderDetailsImpl implements _OrderDetails {
  ...
  @override
  String toString() {
    return 'OrderDetails(id: $id, oderId: $oderId, productId: $productId, price: $price, numberOfProduct: $numberOfProduct, totalMoney: $totalMoney, color: $color, counponId: $counponId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, oderId, productId, price,
      numberOfProduct, totalMoney, color, counponId);
...
abstract class _OrderDetails implements OrderDetails {
  factory _OrderDetails(
      ...
      required final int oderId,
      required final String productId,
      required final double price,
      required final int numberOfProduct,
      required final double totalMoney,
      required final String color,
      required final int counponId}) = _$OrderDetailsImpl;
