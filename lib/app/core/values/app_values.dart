abstract class AppValues {
  ...
  static const int defaultSkipCount = 0;
  ...
  static const double defaultSplashRadiusButton = 25;
  static const double avatarSize = 60;
  static const double iconStoreSize = 30;
  static const double iconFingerSize = 100;
  static double homeSlideHeight = 140.0;
  static double boxUploadImageHeight = 170.0;
  static double chartRevenueSeriesWidth = 0.50;
  static double chartRevenueSeriesSpacing = 0.20;
  static double chartRevenueHeight = 240.0;
  static double boxUploadImageCardIdHeight = 190.0;

  static double cardIdResizeWidth = 1280;
  static double cardIdResizeHeight = 720;
}
